...
const Page = (props) => {
  ...
  const structuredData = getArticleStructuredData(
    'Как избавиться от жирных пятен на од��жде',
          ...
          <div className="page-left-main-box">
            ...
            <section id="3" className="page-thirdproblem2">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Белый столовый уксус (5%) – ��оступный обезжи��иватель. Смешайте одну часть уксуса с 4 частями воды и нанесите раствор на загрязнение. Подождите несколько минут, затем тщательно промойте тёплой водой и постирайте вещь. Аналогично действует раствор лимонной кислоты или свежевыжатый лимонный сок, но такие кислоты ис��ользуют только на белой ткани, чтобы избежать обесцвечивания. После с��ирки запах кислоты исчезает сам.
                </p>
              </div>
            </section>
            ...
            <section id="5" className="page-fiveproblem2">
              ...
              <div className="page-container17">
                <p className="page-text49 vicetext">
                  ...
                  Таким образом, комбинация б��стрых мер (промокнуть пятно, не растирать) и одного из перечисленных методов позволит уд��лить жирный след практически с любой ткани. Важно действовать спокойно и не торопиться – тогда вещь сохранит цвет и форму.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
