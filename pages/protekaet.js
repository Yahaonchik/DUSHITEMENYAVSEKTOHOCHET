          ...
          <div className="page-left-main-box">
            ...
            <section id="2-2" className="page-thirdproblem1-duplicate2">
              ...
              <div className="page-container17">
                <p className="vicetext">
                  {' '}
                  Наиболее сер��ёзная причина – это наруш����ние целостности самого бака (е��кости) машины. Внутри может образоваться дырка из-за мелких острых предметов – чаще всего стальных косточек от ��юстгальтера, проскочивших в барабан. Такие пробоины вызывают неконтролируемый «фонтан»: ��ода течёт непрерывно �� из-под машины в любых режимах. ��ногда бак трескается по шву или по износу деформируется, что тоже даёт теч��.Совет: к сожалению, отремонтировать корпус бака почти невозможн�� – ег�� об����чно заменяют целиком или вместе с барабаном. Чтобы не допустить такого сбоя, тщатель��о проверяйте и чистите вн��тренние карманы у белья. Раз в м��сяц запускайте режим самоочистки с пустым барабаном (если есть) или используйте специальные средства против накипи �� загрязнений. Это уме��ьшит н��к��пление частиц внутри бака и продлит его ресурс.
                </p>
              </div>
            </section>
            <section id="3" className="page-thirdproblem2">
              ...
              <div className="page-container20">
                ...
                <p className="vicetext">
                  {' '}
                  В некоторых случаях вода под м��шиной появляет��я только во время отжима – это характерно для износа подшипни��ов и саль����ика барабана. Сальник (уплотнитель) насоса вращения постепенно истирается, из-за чего в��да попадает внутрь подшипников и ��ыходит наружу. Сначала заметно лишь учащённое включение помпы акв��сто��а (если он есть), а потом ��� ржавая или �� маслянистыми пятнами вода снизу. При этом маши��а громко гремит и «гуляет» на отжиме.Сов��т: осмотреть это ��воими ��илами можно только сняв зад��юю па��ель, но замена подшипников – задача масте��а: приходится разбирать весь бак. Если вы слышите новые скрежет и вибрацию в сочета��ии с лужей под стиралкой, лучше как можно скорее вызвать специалиста. Регулярное использование специальных очис��и��елей и держание м��шины в ровном положении может чуть замедлить износ, но о��ончательно ус��ранить течь сможет только замена сальника и подшипников.
                </p>
              </div>
            </section>
            ...
            <section id="5" className="page-fiveproblem2">
              ...
              <div className="page-container26">
                <p className="page-text49 vicetext">
                  ...
                  <br />
                  <span className="tip-title">6. Не перегружайт�� барабан.</span> Переполнение бель��м нарушает баланс и уве��ичивает нагрузку на уплотните��и и подшипники. Загружайте ровно столько, с��олько ��екомендует производитель.
                  <br />
                  <span className="tip-title">7. Проверяйте напор воды �� фильтры водопровода.</span> Слишком сильный напор мо��ет выдавить воду через дозатор. Установите ��едуктор давления при необходимости и чистите ��етчатый фильтр на входном шланге.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
