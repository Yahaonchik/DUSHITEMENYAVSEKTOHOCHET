...
const Page = (props) => {
  ...
  const structuredData = getProblemPageStructuredData(
    'Ремонт протекающей стирально�� машины',
        ...
        <main className="page-main">
          <div className="page-left-main-box">
            ...
            <AnchorLinksSection
              ...
              items={[
                { icon: '/external/vector8669-r6fr.svg', href: '#2', text: '1. Повреждение ��аливного или сливного шланга' },
                { icon: '/external/vector8669-r6fr.svg', href: '#2-1', text: '2. Течь ��з контейнера для порошка' },
                ...
                { icon: '/external/vector8669-r6fr.svg', href: '#4', text: '5. Разгермет��зация в��утренних патрубков' },
                { icon: '/vector.svg', href: '#5', text: 'Как не допуст��ть протечку' },
              ]}
            />
            ...
            <section id="2-1" className="page-thirdproblem1-duplicate1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Если пос����е набора воды заметили под стира��кой воду в районе лотка для пор��шка, прич��ной часто бывает его засор. Тогда часть воды ��уползает» мимо и вытекает на��ужу. Иногда лоток пр��сто трескается ил�� расслаивается ��о временем – тогда вода тоже может ух���дить прямо через н��го.Совет: регулярно вынимайте и промывайте лоток для порошка и сам патруб��к ��одачи воды в бак. Если д��вление в водопроводе слишком сильное, воду может «выдавить» наружу – по��робу��те немного прикрыть кран подачи. Не используйте слишком м��ого моющего средства и только предназначенные для м��шин порошки – и��быток пены тоже выгоняет влагу наружу. При появлении лужи на полу во время набора воды стоит отключить машинк��, собра��ь бель��� и прочистить ��озатор: обычно это быстро решает проблему.
                </p>
              </div>
            </section>
            ...
            <section id="3" className="page-thirdproblem2">
              ...
              <div className="page-container20">
                ...
                <p className="vicetext">
                  {' '}
                  В н��которых случаях вода под м��шиной появляет��я только во время отжима – это характерно для износа подшипни��ов и саль����и��а барабана. Сальник (уплотнитель) насоса вращения постепенно истирается, из-за чего в��да попадает внутрь подшипников и ��ыходит наружу. Сначала заметно лишь учащённое включение помпы акв��сто��а (если он есть), а потом ��� ржавая или �� маслянистыми пятнами вода снизу. При этом маши��а громко гремит и «гуляет» на отжиме.Сов��т: осмотреть это ��воими ��илами можно только сняв зад��юю па��ель, но замена подшипников – задача масте��а: приходится разбирать весь бак. Если вы слышите новые ��крежет и вибрацию в соч��та��ии с лужей под стиралкой, лучше как можно скорее вызвать специалиста. Регулярное использование специальных очис��и��елей и держание м��шины в ровном положен��и может чуть замедлить износ, но о��ончательно ус��ранить течь сможет только замена сальника и подшипников.
                </p>
              </div>
            </section>
            <section id="4" className="page-fiveproblem1">
              <div className="page-container22 zagolovkiskorobkoy">
                <h3 className="zagolovki2">
                  5. Разгерм��тизация внутренних патрубков
                </h3>
                <svg
                  width="330"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="page-container23">
                ...
                <p className="page-text46 vicetext">
                  {' '}
                  Внутри машины по-прежнему течёт вода – и эт�� легко замет��ть по лужице под ней при заливе. К аварийным патрубкам о��носятся труба от лотка доза��ора к баку и лю��ые трубочк�� между баком, насосом и фильтром. Со времен��м соединения этих патрубк��в ослабевают от пос��оянной вибрации, а сами тру��ки могут забиваться засохшей грязью и мелкими крошками п��рошка. Засорённая или неплотно подсоединённая труба начинает пропускать в��ду на стыках, которая капа��т в ��оддон или сразу на п��л.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <section id="5" className="page-fiveproblem2">
              ...
              <div className="page-container26">
                <p className="page-text49 vicetext">
                  ...
                  <br />
                  <span className="tip-title">3. Следите за шлангами и ��атрубками.</span> Убедитесь, что они хорошо закреплены и не имеют видимых повреждений. Меняйте шланги каждые н��скольк�� лет или пр�� первых признаках износа.
                  <br />
                  <span className="tip-title">4. Де��жите манжету дверцы чистой.</span> Протирайте её после стирки, удаляя о��татки моющих ср��дств и ворса. Осматривайте манжету на предмет трещин и сразу меняйте при необходимости.
                  <br />
                  ...
                  <br />
                  <span className="tip-title">6. Не перег��ужайт�� барабан.</span> Переполнен��е бель��м нарушает баланс и уве��ичивает нагрузку на уплотните��и и подшипники. Загружайте ровно столько, с��олько ��екомендует производитель.
                  <br />
                  <span className="tip-title">7. Проверяйте напор воды �� фильтры водопро��ода.</span> Слишком сильный напор мо��ет выдавить воду через дозатор. Установите ��едуктор давления при необходимости и чистите ��етчатый фильтр на входном шланге.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
