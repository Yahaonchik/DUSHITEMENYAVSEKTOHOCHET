          ...
          <div className="page-left-main-box">
            ...
            <section id="2-2" className="page-thirdproblem1-duplicate2">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Прессостат (датчик у��овн�� воды) сообщает моду���� ��правления о наполнении бака, и по сиг��алам датчика регулируется п��дача воды. Если прессостат заб��т или сломан, ��ашина может не начать нагревать воду – она не «увидит» необходимый уровень, чтобы включить ТЭН. Для прове��ки открывают переднюю панель и визуально осматривают трубку к прессоста��у (обычно видно под п��нелью или около насоса) на засор��� и перетяжки. Кроме того, прозванивают контакты датчика тестером. В большинстве случаев чистят внутреннюю трубку ��т гр��зи и мелкого мусора (н��пример, нитей или монет). Если же да��чик повреждён (нет реакци�� или неправильные показания), его заменяют новым
                </p>
              </div>
            </section>
            <section id="3" className="page-thirdproblem2">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Часто бывает, чт�� клеммы или провода, идущие к ТЭНу и датчикам, ослабе��ают или окисляются. Например, плохой к��нтакт на клеммах ТЭНа приводит к т��му, что элемент вообще не вклю��ается (или греется местно – проверяйте по п��черневшей изоляции и оплавленным клеммам). Для диагнос����ики отключают машину от сети и мультиметром прозва��ивают всю ��епь питания ТЭНа и датчиков (исправный сигнал «должен быть», обрыв или короткое явно ук��жут на проблему). Визуально проверяют целостность проводов и коннекто��ов. При обнаружении плохого контакта или обрыв�� пров��дов провода меняют, а клеммы зачищают и плотно затягивают. ��осле этого вновь ��ро��еряют нагрев – если проводка и вилка исправны, Т��Н ��нова н��чнёт греться.
                </p>
              </div>
            </section>
            <section id="4" className="page-fiveproblem1">
              ...
              <div className="page-container17">
                ...
                <p className="page-text46 vicetext">
                  {' '}
                  Электронный блок управления (ЭБУ) — эт�� «мо��г» машины. Если в нём выходят из строя силовые реле, повреждается плата или программируется ош��бка, то команда на нагрев мож��т просто не подаваться. Распознать такую неисправность самостоятельно сложно: чаще всего на дисплее п��является соответствующий код, либо машина не реагирует на любые настройки. Проверку и ремонт модуля обыч��о доверяют специалисту, однако ясно одно: при любой проблеме с платой подачу напряжен���� на ТЭН прекращают, и новая плата или ремонт старой пол��остью ре��ают проблему. Самостоятельно можно т��лько убедиться, что напряжение в розетке подаётся и модули питания целы; для сложного ремонта платы лу��ше пригласить мастера.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <PageNavigation
              prevPage={{
                href: '/neslivaetvodu',
                title: 'Стиральн��я машина н�� ��ливает воду'
              }}
              nextPage={{
                href: '/protekaet',
