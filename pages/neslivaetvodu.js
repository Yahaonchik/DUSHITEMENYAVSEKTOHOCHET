      ...
      <div className="page-container10">
        ...
        <main className="page-main">
          <div className="page-left-main-box">
            ...
            <AnchorLinksSection
              title="Основные пр��чи��ы отсутствия сл��ва:"
              items={[
            ...
            <section id="2" className="page-thirdproblem1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  ...
                  на сли��. Обычно в этом ��лучае машина останавливается �� кодами
            ...
            <section id="2e" className="page-thirdproblem1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Гибкий сливной шланг идёт от насоса к стояку канализации. Важно у�����ед��тьс��, что он не пережат и не забит ��рязью или жи��ом, особенно в ��естах изги��ов и по����оединения к р��ковине или сифону. Для проверки отсоедин��те ��ланг от канализации и попробуйте п���одут�� его: при ч����том шланге воздух проходит легко и сл��шно, как булькает оставшаяся вода. Если шланг забит, пр��толкн��те внутрь гибкую пр��волоку или промойте его п������ струёй горячей воды. После прочистки у��тановите шланг на место и убедитесь, что он нигде не пер��гибае��ся �� надёжно за��реплён.
                </p>
              </div>
            </section>
            <section id="3" className="page-thirdproblem2">
              ...
              <div className="page-container17">
                ...
                <div className="vicetext">
                  ...
                  <p><strong>3. Дайте воде остыть.</strong><br />Если стирка была недавно, дождитесь остывания. Оцени��е температуру по стеклу люка: если оно горячее — подождите.</p>
            ...
            <section className="page-frame1299" style={{display:"none"}}>
              ...
              <div className="page-frame12982">
                <span className="page-text74">
                  ��ак продлить жизнь машине на 3–5 лет — простые привычки,
