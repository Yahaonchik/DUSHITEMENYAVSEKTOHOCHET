      ...
      <div className="page-container10">
        ...
        <main className="page-main">
          <div className="page-left-main-box">
            ...
            <AnchorLinksSection
              title="Основные пр��чины отсутствия сл��ва:"
              items={[
                { icon: '/external/vector8669-r6fr.svg', href: '#1', text: '1. Засор сливного ��ильтра' },
                ...
                { icon: '/external/vector8669-r6fr.svg', href: '#2c', text: '4. Сбой или поломка мо��уля ��правления' },
                { icon: '/external/vector8669-r6fr.svg', href: '#2d', text: '5. Засор сливног�� патрубка' },
                { icon: '/external/vector8669-r6fr.svg', href: '#2e', text: '6. Засор сливного ��ланга' },
                { icon: '/vector.svg', href: '#3', text: 'Как самостоятельно слить воду:' },
                { icon: '/vector.svg', href: '#4', text: '��оветы по профила��тике:' },
              ]}
            />
            ...
            <section id="2" className="page-thirdproblem1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  ...
                  на сли��. Обычно в этом случае машина останавливается �� кодами
            ...
            <section id="2d" className="page-thirdproblem1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Слив��ой патру��ок (гофра) соединяет бак с насосом. Даже после чистки фильтра вода может не уходить, если в этом па����убке что-то застряло. Чаще всего вну��рь попадают ��онеты, пуговицы, обрывки ткани – они могут ��е��иодически перекрывать проток в��ды.Чтобы провери��ь патрубок, отключ����те машину, уло��ите её на бок и ��нимите заднюю или нижнюю панель. Далее отсоедините патрубок от насос��: внутри часто обнар��жива��тся мелки�� тряпочк��, носк�� и мелкие детали. Уд��лите из патрубка мусор. После сборки ��роверьте слив – при отсутст��ии за��ора в��да до��ж��а св����одно уходить.
                </p>
              </div>
            </section>
            ...
            <section id="4" className="page-fiveproblem1">
              ...
              <div className="page-container17">
                <p className="vicetext">
                  {' '}
                  1. ��егулярно очищайте фильтр. ��истый фильтр предотвращает заторы из ворса и мелкого мусора.2. Не допускайте п��падания м����ких предметов. Проверяйте карманы одежды перед сти��кой: монет��, заколки, носовые платки и т.п. часто попадают в б��рабан и могут попасть в патрубок.3. Следите за пол��жение�� сливного шланга. Шланг не должен сильно переги��аться или пережиматься. Оптимальная высота его вывода – до 50 см от уро��н�� пола. При ��ксплуатации следите, чтобы машинка стояла ровно ��� вибрировала минимально: излишняя вибрация мож��т пе���етёреть провода или ослабить пат��убки.4. Не за��ывайте провер��ть ка��ализацию. Убедите��ь, что в стояке или сифоне нет за��ора. Если вода из раков��ны уходит медленн��, жидкость из с��ираль��ой может застаиваться. Время от времени очищайте сантехнику в доме, чтобы слив маши��ы работал беспрепятственно.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <section className="page-frame1299">
              ...
              <div className="page-frame12983">
                <span className="page-text75">
                  Почему стиралка воняет — 7 быстрых п��и��ин и что сделать прямо
                  сейчас
                </span>
