          ...
          <div className="page-left-main-box">
            ...
            <AnchorLinksSection
              ...
              items={[
                ...
                { icon: '/vector.svg', href: '#4', text: 'Советы по профила��тике:' },
              ]}
            />
            ...
            <section className="page-frame1299">
              ...
              <div className="page-frame12983">
                <span className="page-text75">
                  Почему стиралка воняет — 7 быстрых п��ичин и что сделать прямо
                  сейчас
                </span>
