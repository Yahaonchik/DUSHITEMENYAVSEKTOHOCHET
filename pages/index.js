      ...
      <main className="frame1196-container100">
          ...
          <article className="frame1196-cards">
            ...
            <Link href="/protekaet">
              <a className="frame1196-container115">
                <p className="frame1196-text114">С��ир��льная машина протекает</p>
            ...
            <Link href="/silnoshumit">
              <a className="frame1196-container116">
                ...
                <Image alt="Ст��ральная машина шумит при ��тжиме" src="/problems/4-300h.webp" layout="fill" objectFit="cover" className="frame1196-image18" priority />
              </a>
            </Link>
        ...
        <section className="frame1196-container123">
          <p className="frame1196-text122">
            ...
            <span className="frame1196-text124">Ваше наз��ание </span>
            ...
            <span className="frame1196-text128">
              Профе��сио��ал���но устраняем любые неисправности стиральных машин —
              от с��мых просты�� д�� самых сложных.
            </span>
            ...
            <div className="frame1196-container129">
              <div className="frame1196-container130">
                ...
                <p className="frame1196-text138">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: 'Не нужно ждать несколько дней - ваша техника заработае�� уже сегодня.',
                    }}
                  ></span>
                </p>
              </div>
            ...
            <div className="frame1196-blue2">
              <div className="frame1196-container137">
                ...
                <span className="frame1196-text148">
                  Д���агн��стика �������борудования (при ремонте)
                </span>
              </div>
              <div className="frame1196-container139">
                <span className="frame1196-text149">Бесп��атно</span>
                <svg
                  width="100%"
                  xmlns="http://www.w3.org/2000/svg"
                  height="20"
            ...
            <div className="frame1196-blue4">
              <div className="frame1196-container145">
                ...
                <span className="frame1196-text212">
                  Замена подшипн��ков( с учетом ст��имости по��шипников)
                </span>
              </div>
        ...
        to {
          ...
          <div className="frame1196-container151 carousel">
            <div className="frame1196-container152 track">
              ...
              <div className="item">
                <img
                  alt="��емонт стиральны�� машин Candy в Одессе - профе��сиона��ьный се��вис"
              ...
              <div className="item">
                <img
                  alt="Ремонт ��тира��ь��ых м��шин Gorenje в Одессе - п����фессиональн��й ��ервис"
              ...
              <div className="item">
                <img
                  alt="Р��м��нт стиральных м���шин Atlant в Одессе - пр��фессиональ����ый сервис"
              ...
              <div className="item">
                <img
                  alt="Ремонт стиральных машин Miele в Од��ссе - пр��фессион���льный ����р��ис"
              ...
              <div className="item">
                <img
                  alt="Ремонт стир���льных ��ашин Indesit в ��дессе - профе����и��н����льный серв���с"
...
to {transform: translateX(-2620px);}}
                ...
                <div className="frame1196-container165">
                  <div className="frame1196-container166">
                    <h3 className="frame1196-text218">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: 'Со����р��менное оборуд��ван��е по д��агностике',
                        }}
                      ></span>
                    </h3>
                    <svg
            ...
            <div className="frame1196-container167">
              ...
              <div className="frame1196-container168">
                ...
                <p className="frame1196-text221">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: 'Получаем нужные з��пчасти быстро, по выгодным ценам �� без ��ерепл��т.',
                    }}
                  ></span>
                </p>
              </div>
            ...
            <div className="frame1196-container171">
              ...
              <div className="frame1196-container172">
                ...
                <p className="frame1196-text223">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: 'Выполняем работу качественно �� до��тупно, без с��рытых до��ла�� и ненужных расходов.',
                    }}
                  ></span>
                </p>
              </div>
            ...
            <div className="frame1196-container179">
              ...
              <div className="frame1196-container180">
                ...
                <p className="frame1196-text227">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: 'По��твержда���� надёжность ремонта длительным сроком гарантии.',
                    }}
                  ></span>
                </p>
              </div>
            ...
            <div className="frame1196-container191">
              <div className="frame1196-container192">
                <figcaption className="frame1196-text232">
                  Устано���ка новой ����улки уплотнит��ля
                </figcaption>
              </div>
            </div>
            ...
            <div className="frame1196-container199">
              <div className="frame1196-container200">
                <figcaption className="frame1196-text236">
                  В���сс��ановление ����прав��яющей п��аты на Siemens
                </figcaption>
              </div>
            </div>
          ...
          <div className="frame1196-container221">
            <div className="frame1196-container222">
              ...
              >
                <span
                  dangerouslySetInnerHTML={{
                    __html: 'Де��евле отремонтироват�� ����и заменить?',
                  }}
                ></span>
              </h3>
            </div>
            <div className={`frame1196-otvet5 ${activeFAQ === 5 ? 'faq-active' : ''}`}>
                <p className="frame1196-text248">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: 'Если стоимость р��мо���та п��евышает 60% ��т цены новой ����шины - ��учше заменить. Мы всегда честно консультиру��м ������ целесообразно���ти ��ем��нт���.',
                    }}
                  ></span>
                </p>
            </div>
        ...
        <div className="frame1196-container225">
          ...
          <p className="frame1196-text251 textITOGI">
            <span
              dangerouslySetInnerHTML={{
                __html: 'Ст��ральная машина — это те��ника, ко��орая должна работать исправн��: отжима��ь, стирать и радовать стабильнос���ью. Н�� на практике даже самая над��жная техника со времен��м требует внимания. Механическ��е детали ��знаш��ваются, электрони��а даёт с��ои, а ��ыто��ая нагрузка делает своё дело. Вот почему ремонт стиральных ��ашин в Одессе — э��о не просто разовая ус��уга, а реальна���� необходимость для большинства владельцев. Важно доверить ремонт проверенным специалистам, а не случайному маст��ру.',
              }}
            ></span>
          </p>
          ...
          <ul className="frame1196-ul1 list">
            <li className="list-item">
              <span className="textITOGI">
                <span
                  dangerouslySetInnerHTML={{
                    __html: 'Н�� рынке ремонта бытово�� техники с 2011 года.',
                  }}
                ></span>
              </span>
            </li>
          ...
          <p className="frame1196-text260 textITOGI">
            <span
              dangerouslySetInnerHTML={{
                __html: 'Ремонт с��иральных машин в Одессе необходим как новым, так и давно ис��ользованным моделям. Все узлы техники имеют ограниченный ресурс, и при активной эксплуатации однажд�� выходят из строя. Мы собрали самые частые причины, по которым клиенты обращаю��ся в наш серви��:',
              }}
            ></span>
          </p>
          <ul className="frame1196-ul2 list">
            ...
            <li className="list-item">
              <span className="textITOGI">
                <span
                  dangerouslySetInnerHTML={{
                    __html: '����чёт корпус — уст����няе�� утечки, заменяем шланги, м��нжеты, ������т����убки.',
                  }}
                ></span>
              </span>
            </li>
            ...
            <li className="list-item">
              <span className="textITOGI">
                <span
                  dangerouslySetInnerHTML={{
                    __html: 'Регулярное тех��бслуживан���� — профилакти��а раз в 12 месяцев продлевае�� срок ����ужбы.',
                  }}
                ></span>
              </span>
            </li>
          ...
          <p className="textITOGI">
            <span
              dangerouslySetInnerHTML={{
                __html: 'Ниже на сайте — карта про��зда к наш��й мастер��к��й, а также наши телефоны. Звоните для записи, консультации или если з��метили сбои в работе ��ашей стиральной ��ашины. Мы всё объясним, рассчитаем стоимость и поможем."Ваше название" — это ремонт стиральных машин �� Одесс�� быстро, надёжно и профессио���ально.',
              }}
            ></span>
          </p>
        </div>
        ...
        <div className="frame1196-container228">
          <article className="frame1196-frame10721">
            ...
            <p className="frame1196-text276">
              ...
              с��ома���а �� ����е могу пла����ть на взрыд во время отжима.
            </p>
            <svg
              width="330"
              xmlns="http://www.w3.org/2000/svg"
