          ...
          <div className="page-left-main-box">
            ...
            <div className="page-container15">
              <h2 className="page-text34">
                <span>Основные пр��чины п��ломки:</span>
                <br></br>
              </h2>
            </div>
            ...
            <section id="3" className="page-thirdproblem2">
              ...
              <div className="page-container20">
                ...
                <p className="vicetext">
                  {' '}
                  Если ��атчик неправил��но определяет уровень воды, блок управлен��я не срабатывает нормально. При этом м��шинка может «зави��ать» перед отжимом – она не сливает воду полно��тью и аварийно останавливается. Признаки: после завершения стирки в баке ост��ётся вода, могут появляться ошибки уровня воды. Решается замена прессостата.
                </p>
              </div>
            </section>
