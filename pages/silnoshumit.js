...
const Page = (props) => {
  ...
  const structuredData = getProblemPageStructuredData(
    ...
    'Професс��ональный ремонт стиральных м��шин которые шумят и вибрируют в Одессе. Замена подшипников, амортизаторо��.',
    `${baseUrl}/silnoshumit`
  )
      ...
      <div className="page-container10">
        ...
        <main className="page-main">
          <div className="page-left-main-box">
            ...
            <AnchorLinksSection
              title="Основные причины сильного шум��:"
              items={[
                ...
                { icon: '/external/vector8669-r6fr.svg', href: '#5', text: '2. Пружины подвес��и' },
            ...
            <section id="3" className="page-thirdproblem2">
              ...
              <div className="page-container20">
                ...
                <p className="vicetext">
                  {' '}
                  ��тиральная машина очень требо��а���ельна к прочн��сти и горизонтальности места установки. Есл�� пол под ней н�� идеальн�� ровный или сл��шко�� мягкий (нап��имер, с��арые дере��янные доски), любая вибрация пр��ведёт к дополнительном�� «пры��ку» техники. Аналогично, установка на оче��ь гл��дком покрытии (плитке или линолеуме) без фиксации позволит машинке подскальзывать.Совет: Проверьте положение машины уровнем – все ножк�� ��олжны стоять устойчиво. Слегка раскачайте прибор руками, определите, какая опора «гуляет�� ��ольше, и по��крутите её гайкой против часовой стрелки до упора. Можно привлечь помощника или приподнять сти��алку на бок, чтоб�� повернуть ножку удобнее. После этого ещё раз проконтролируйте ровность с уров��ем. Для дополнительной устойчивости и защи��ы пола рекомендует��я установить резиновые антиск��льзящие накладки или антивиб��аци��нные подставки под ножки. Они гасить час��ь вибрации и не позволяют машине «ездить» по комн��т��.
                </p>
              </div>
            </section>
            <div className="page-container15">
            ...
            <section id="5" className="page-fiveproblem2">
              ...
              <div className="page-container26">
                ...
                <p className="page-text49 vicetext">
                  {' '}
                  Пружины подвески играют ключевую роль в работе стиральной машины — они удерживают бак в подв��шенном состоянии и компенсируют вибрации при отжиме. Ког���� хотя бы одна пружина растянулась или сломала��ь, бак теряет устойчивость и начинает сильно раскачиваться. Из-за ��того вы слышите громкий стук, глухие удары или даже металлический звон. Особе���но ярко проблема проявляетс�� на высоких оборотах, когда бак с бельём вращается �� макси��альной скоростью.

                  Почему это происходит? С�� временем пружины изнашиваются — металл теряет упругость, появляются микротрещины, а иногда пру��ина может и вовсе лопнуть. В результате на��рузка распределяется н���равномерно, бак смещается и начинает «бить» по корп��су. Это не только неприятный шум, но и риск повреждения других деталей — амо��тизаторов, противовесов, даже бака.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <section id="5-1" className="page-fiveproblem2-duplicate1">
              ...
              <div className="page-container26">
                ...
                <p className="page-text49 vicetext">
                  {' '}
                  Противовесы — это массивные блоки внутри стиральной машины, которые ��репятся к баку и пом��гают ��асить вибрации при стирке и особенно при отжим��. Их задача — стабилизировать бак, чтобы он не раскач��вался и не ударялся о кор��ус. Если один из противовесов ослаб, раскололся или открутился, бал��нс нарушается, и машина начинает сильно шуметь, греметь и «��рыгать» по пол��.Со временем крепёжные болты противовесов могут раскрутиться из-за постоянной вибрации. В некоторы�� случаях бетонный противовес трескается или крошится — это встречается ��а старых машинах или после сильных перегрузок бельём. Когда противовес не держи��ся плотно, при высоких оборотах бак с��ещается и начинае�� сильно стучать по корпусу.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <section id="5-2" className="page-fiveproblem2-duplicate2">
              ...
              <div className="page-container26">
                ...
                <p className="page-text49 vicetext">
                  {' '}
                  В барабан встроен подшипниковый узел – обычно два ��арикоподшипника, ��акрытые резиновым уплотнителем (сальн��ком). При длительной эксплуатации сальник протирается, внутрь попадает вода, ��мазка вымывается и подшипники ржавеют. Это вызывает люфт барабана �� неравномерное вращение. В итоге при отжиме машина может ��ильно шуметь и «прыгать», а иногд�� барабан клинит. Признаки износа подшипников – топот под ��ашиной, подтеки ржавой воды и разболт����ность бака при ручном движении. Починка ������ребу��т замены подшипников (и сальника) – в б��льшинстве моделей это компл��ксная работа, выпол��яемая в сервисе.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <PageNavigation
              prevPage={{
                href: '/protekaet',
                title: 'С��иральная машина протекает'
              }}
              nextPage={{
                href: '/nevkluchaetsa',
