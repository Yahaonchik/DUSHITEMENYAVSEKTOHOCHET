...
const Page = (props) => {
  ...
  const structuredData = getProblemPageStructuredData(
    ...
    'Профессион��льный ремонт ��тиральны�� машин которые зависают на программах в Одессе. Ремонт модуля управления.',
        ...
        <main className="page-main">
          <div className="page-left-main-box">
            ...
            <section id="1" className="page-firstproblem">
              <div className="page-container12 zagolovkiskorobkoy">
                <h2 className="zagolovki2">
                  Ч��о делать, если программа зависла:
                </h2>
                <svg
                  width="330"
              ...
              <div className="page-container13">
                <p className="vicetext page-text18">
                  ...
                  <br />
                  Если вода не уходит при штатных попытках, подставьте под фильтр глубоку�� ёмкость. Открутите сливной фильтр против часовой с��рел��и. После откручивания вода пойдёт в ёмкость; Слейте всю жидкость и уб��рите ��усор из фильтра и отверстия. Такие д����ствия помог��ют во����становить слив во многих случаях.
                  <br />
                  <strong>4. После ручного слива можно без��пас��о открыть люк.</strong>
                  <br />
            ...
            <section id="2" className="page-thirdproblem1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Сливной фил��тр — это сетчатый элемент на передней нижней ча��ти машины, который задерживает ворсинки, мелкий мусор и мелкие п��едметы при сливе. Если филь��р забит, вода не ��ходит из бака, бельё остается мокрым, а насос (помпа) не может откачать жидкость. Программа может «зависнут��» на этапе слива или отжима. Проверьте, не г��дит ли насос без слива или не остаётся ��и вода после цик��а — это признаки засора. Проверьте фильтр. Удалите грязь и скопившийся м��сор, промойте фильтр тёплой водой и закр��тите обратно. Обыч��о э��у процедуру м��жно ��ыполнить самостоятельно (важно предварительно слить воду че��ез фильтр или аварийный слив). Если после очистки фильтра машин��а снова работает нормально, причина найдена. Ес��и фильтр чист и вода всё равно не уходит, проблема может быть глубже (насос, шланги и т.д.).
                </p>
              </div>
            </section>
            <section id="2a" className="page-thirdproblem1">
              <div className="page-container16 zagolovkiskorobkoy">
                <h3 className="zagolovki2">
                  2. Неплотно закрыт люк или неисправен замо��
                </h3>
                <svg
                  width="330"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <section id="2c" className="page-thirdproblem1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Блок управления (электронная плата) ��� «мозг» стиральной машины, который у��равляет всеми узлами. При скачке напряжения или сбоя ��лектроники п��ограмма может зависнуть или не реагиро��ать на кн��пки. Обычно это называется «р��зовы�� сбоем модуля». Перезагрузите ��а��ину: выдерните вилку из розетки н�� 10–15 минут, затем включите вновь. Если сбой был едини��ным, по��ле паузы машина начнет работать. Если же проблема по��торя��тся (п����ограмма регулярно зависает, гаснет подсветка, на табло появляются стр��нные символы), нужна диагно��тика платы. Повреждения в модуле управления устранить сложно — ��аще всего его перепрошивают или заменяют. Без опыта ремонтов электроники не стоит разбирать плату самому.
                </p>
              </div>
            </section>
            <section id="2d" className="page-thirdproblem1">
              <div className="page-container16 zagolovkiskorobkoy">
                <h3 className="zagolovki2">
                  5. Проблемы с датч��ком ��ровня в��ды (прессостат)
                </h3>
                <svg
                  width="330"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <PageNavigation
              prevPage={{
                href: '/nevkluchaetsa',
                title: 'Стиральная машина не включ��ется'
              }}
              nextPage={{
                href: '/neotjimaet',
            ...
            <section className="page-frame1299" style={{display:"none"}}>
              ...
              <div className="page-frame12984">
                <span className="page-text76">
                  ��ак с��кономить элек��ричест��о и воду — реальные настройки и
                  ��айфхаки
                </span>
