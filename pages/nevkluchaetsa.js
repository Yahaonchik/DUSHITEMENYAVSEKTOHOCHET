          ...
          <div className="page-left-main-box">
            ...
            <AnchorLinksSection
              ...
              items={[
                ...
                { icon: '/vector.svg', href: '#2', text: 'Основны�� ��ричины поломки:' },
              ...
              <div className="page-container13">
                ...
                <div className="vicetext">
                  ...
                  <p>
                    ...
                    Убедит��сь, что автомат в электрощите включён, а ��ровод п��тания и розетка не повреждены. Подключите к той же розетке дру����й прибор, чтобы убедиться, что пи��ание ��сть.
                  </p>
                  ...
                  <p>
                    <strong>4. Пров��рьте подачу воды.</strong><br />
                  ...
                  <p>
                    ...
                    Отключите машину от сети на несколько минут (примерно на 10–15), за��ем включите снова. Ино����да одно��ратный «глюк» электроники устраняется сбросом питания.
                  </p>

                  <p>
                    <strong>6. Проверьте фи��ьтры и шланги.</strong><br />
                    Если машинка всё е��ё н�� подаёт признаков ж��зни, осмотрите сетевой фильтр и впус��ной клапан. Для фильтра ну��ен мультиметр, для клап��на — визуальны�� осмотр или звон мастеру. Часто эти детали меняют полностью.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section id="3" className="page-thirdproblem2">
              ...
              <div className="page-container20">
                ...
                <p className="vicetext">
                  {' '}
                  В большинстве современных машин стоит сетевой фильтр, который защищает электронику от скачков напряжения. Когд�� он выходит из строя, машинка переста��т реаги����вать на в��лючение. Симптомы — шнур и ��озетка исправны, но техника полностью «мертва». Проверить фильтр можно мультиметром (или доверить мастеру). Иногда на корпусе фильтра ��идны следы п��дгорания. Если элемент неисправен, его просто меняют на новый.
                </p>
              </div>
            </section>
            <section id="4" className="page-fiveproblem1">
              ...
              <div className="page-container23">
                <figure className="page-container24">
                  ...
                  />
                  <span className="page-text45">Модуль упр��вления</span>
                </figure>
                <p className="page-text46 vicetext">
                  {' '}
                  Мозг ст��ральной машины — это у��равляющая плата. Именно она хранит программы стирки и управляет всеми процессами. Если ��на выходит из строя, техника не запускается, индикаторы не горят или ведут себя странно. Иногда ��омогает простой сброс: отключите питани�� на 10–20 минут и попробуйте снова. Если не помогло — скорее всего, нужна прошивк��, ��емонт или замена модуля. Этим обычно занимается специалист.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <section id="5" className="page-fiveproblem2">
              ...
              <div className="page-container26">
                ...
                <p className="page-text49 vicetext">
                  {' '}
                  Двигатель стиралки питается ��т электрических щёток на коллекторе ротор��. При сильном износе щё��ок двигатель либо не запуска��тся совс��м, либо работает с перебоями. Яркий признак неисправности щёток — барабан перестаёт вращаться: машина вкл��чен��, напор воды есть, н�� барабан «не крутит». Ещё один симптом — искры или ��еобычные «скрежещущие» звуки при попытке запустить стирку. Обычно это происходит из-за плохого контакта щёток с ��отором (они коротко замк��уты или стёрлись). На дисплее в таких случаях могут появляться сервисные коды (хотя обычно исчезают, к��гда машина остывает). Проверьте щётки двигателя: в большинстве моделей это доступно после снятия задней крышк�� и корпуса мотора. Если щетки сильно короткие или имею�� сколы, их нужно заменить. Это относительно прос��ая и недорогая операция — её выполняе�� мастер или даже домашний умелец. ��ока щетки не заменены, стиралк�� не запустится (особенно при больших нагрузках).
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <section id="5-2" className="page-fiveproblem2">
              ...
              <div className="page-container26">
                ...
                <p className="page-text49 vicetext">
                  {' '}
                  Если индикаторы на панели загор��ются, но после включения программа не стартует, обр��тите внимание на подачу воды. Во время цикла маши��ка должна заблокировать люк и тут же начать залив воды. Если воды нет (или не подаётся), стирка ��е начнётся. Сначала проверьте, отк��ыт ли кран водо��набжения для машины и не пережат ли заливной шланг. Без наличия воды стиралка просто не запустится. Если с подачей воды вс�� в по��ядке, возможен отказ впускного (заливного) клапана. Это электромагнит, открывающий подачу воды при команде блока управлен��я. Признаки: ��ашинка ��локирует л����, пытается набрать воду (можно услышать гудение), но бак ��стаётся пустым. На дисплее может мигать ошибка «нет воды» (например, код H2O у Indesit или F02 у Bosch). Иногда заливается вода то��ько на некоторые программы (например, полоскание) — это из-з�� того, что современные стиралки используют д����ойной клапан и может выходить из строя только один из его патрубков. Что делать: убедит��сь, что кран открыт и шланг не изогнут. Если вода есть, но машинка всё равно не набирает, скорее всего, впускной клапан неисправен или забит мусором. Нередко в корпусе кла��ана устанавливается мелкая сеточка-фильтр — её можно очистить. Если проверка не помогла, потребуется заменить клапан на новый. Это уже задача мастера: самост��ятельно без оп��т�� лучше не рисковать.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
