...
const Page = (props) => {
  ...
  const structuredData = getArticleStructuredData(
    ...
    'Как быстро и аккуратно вывести пят��а к��ови с разных тканей, не повредив их',
          ...
          <div className="page-left-main-box">
            ...
            <section id="2" className="page-thirdproblem1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Сначала промойте пятно очень холод��ой водой, чтобы смыть как можно больше крови. Затем нанесите на влажное место густую мыльную пену – хорошо подходит хозяйственное мыло. Мыло ос��авляют на 20–30 минут (можно накрыть плёнкой) и снова смывают прохладной водой. Это�� простой способ эффективен для свежих и слегка засохших следов. Для более стойких пятен в мыльный раствор можно до��авить немного мелкой соли или стирального порошка.
                </p>
              </div>
            </section>
            ...
            <section id="4" className="page-fiveproblem1">
              ...
              <div className="page-container17">
                ...
                <p className="page-text46 vicetext">
                  {' '}
                  Аммиак (нашатырный спирт) хорошо помогает от сильных пятен крови на белом хлопке и ль��е. На 3 литра холодной воды добавьте 60 ��л н��шатыря, замочите вещь на 1���2 часа, затем тщательно прополощите и ���остирайте. Для цветных тканей можно использовать специализированные ферментные пятновыводители. В их сос��аве есть протеиназы – ферменты, разрушающие белковые загрязнения. Нанесите препарат согласно инструкции (обычно на 15��30 минут), а потом выстирайте вещь. Такие средства особенно эффективны, если другие методы не помогли.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <section id="5" className="page-fiveproblem2">
              <div className="page-container25 zagolovkiskorobkoy">
                <h3 className="zagolovki2">
                  6. Глицерин (нетриви��льный способ)
                </h3>
                <svg
                  width="330"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <PageNavigation
              ...
              nextPage={{
                href: '/protekaet',
                title: 'Стирал��ная маши��а протекает'
              }}
            />
            <svg
              width="330"
