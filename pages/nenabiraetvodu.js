        ...
        <main className="page-main">
          <div className="page-left-main-box">
            ...
            <AnchorLinksSection
              ...
              items={[
                { icon: '/external/vector8669-r6fr.svg', href: '#1', text: '����то делать, если машина не набирает воду?' },
                { icon: '/vector.svg', href: '#2', text: 'Ос��овные причины поломки:' },
                { icon: '/external/vector8669-r6fr.svg', href: '#2', text: '1. Закрыт кран подачи воды / ��изкое давление' },
                { icon: '/external/vector8669-r6fr.svg', href: '#3', text: '2. Повреждён замок дверцы (блокировка люка).' },
                { icon: '/external/vector8669-r6fr.svg', href: '#4', text: '3. Пе��ежат или перекручен заливной шланг' },
                { icon: '/external/vector8669-r6fr.svg', href: '#5', text: '4. ��еисправен впускной клапан' },
                { icon: '/external/vector8669-r6fr.svg', href: '#5-1', text: '5. Неисправность датчика уровня воды (прессостата)' },
                { icon: '/external/vector8669-r6fr.svg', href: '#5-2', text: '6. Повре��дён модуль управления' },
              ]}
            />
            <section id="1" className="page-firstproblem">
              ...
              <div className="page-container13">
                <div className="vicetext">
                  ...
                  <p>
                    <strong>4. Оч��стите сетчатый фильтр.</strong><br />
                    Перекройте воду, аккуратно открутите шл��нг у машины и достаньте сеточку-фильтр. Промойте её от загрязне��ий под сильной струёй или поч��стите щёткой. Соберите всё обратно.
                  </p>
            ...
            <div className="page-container15">
              <h2 className="page-text34">
                <span>Основны�� ��р��ч��ны поломки:</span>
                <br></br>
              </h2>
            </div>
            <section id="2" className="page-thirdproblem1">
              <div className="page-container16 zagolovkiskorobkoy">
                <h3 className="zagolovki2">
                  1. Закрыт кран подачи воды / ��изкое давлен��е
                </h3>
                <svg
                  width="330"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Во��яной кран – это вент��ль на трубе, подающей воду к машинке. Если он закрыт или нап��р воды очень слабый, вода в машину просто не поступает. Признак тако�� неисправн��сти: машина пытается начать работу (гудит), но вода не набирается или идёт очень медленно. Убедит��сь, что вентиль п��лностью открыт (ручка параллельна трубе).Если напор в кране ��лабый, попробуйте подождать стабилизации давления или сообщить об этом в ЖКХ. Если к��ан сломан или не держит герметичность, вызовите сантехника или мастера.
                </p>
              </div>
            </section>
            ...
            <section id="4" className="page-fiveproblem1">
              <div className="page-container22 zagolovkiskorobkoy">
                <h3 className="zagolovki2">
                  3. Пе��ежат или перекруче�� заливной шл��нг
                </h3>
                <svg
                  width="330"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <section id="5" className="page-fiveproblem2">
              ...
              <div className="page-container26">
                ...
                <p className="page-text49 vicetext">
                  {' '}
                  Впус��ной клапан – электромагнитный клапан внутри машины, к��торый открывает и закрывает поток воды по команде платы. При его поломке клапан не открыв��ется полностью и машина ��изически не может набрать нужное количество воды. Признаки: люк закрыт, машина включается, но вода не пост��пает или поступает очень мало, на дисплее может загореться код ош��бки набора воды. Этот узел ��е подлежит ремонту — при подозрении на его поломку нужно вызват�� мастера, который заменит клапан
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <section id="5-1" className="page-fiveproblem2">
              ...
              <div className="page-container26">
                ...
                <p className="page-text49 vicetext">
                  {' '}
                  Прессостат ��� да��чик, ��пределяющий уровень воды в баке. Если прессостат «залип» (считал бак полным) или вышел из строя, машина не начнёт зали�� воды вообще. Симптомы сх��жи с к��апаном: л��к блокируется, но залива нет, появляется ошибка «набор воды» или «прессостат» на дисплее. Иногда вода может сливать��я сразу, создаётся ложная сигнализация об избыточном уровне. Пользова��ель может прове��ить шланг прессостата на засор (и прочистить его), но обычно требуется зам��на датчика.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
