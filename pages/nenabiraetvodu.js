          ...
          <div className="page-left-main-box">
            ...
            <section id="5-1" className="page-fiveproblem2">
              ...
              <div className="page-container26">
                ...
                <p className="page-text49 vicetext">
                  {' '}
                  Прессостат ��� да��чик, ��пределяющий уровень воды в баке. Если прессостат «залип» (считал бак полным) или вышел из строя, машина не начнёт зали�� воды вообще. Симптомы сх��жи с к��апаном: л��к блокируется, но залива нет, появляется ошибка «набор воды» или «прессостат» на дисплее. Иногда вода может сливать��я сразу, создаётся ложная сигнализация об избыточном уровне. Пользова��ель может прове��ить шланг прессостата на засор (и прочистить его), но обычно требуется замена датчика.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
