  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        .pm-icon-whatsapp { bottom: 42px; left: 18%; transform: translateX(-50%) translate(45px, -33px); }
        .pm-icon-telegram { bottom: 50px; left: 50%; transform: translateX(-50%) translate(-2px, -5px); }
        .pm-icon-viber { bottom: 42px; left: 82%; transform: translateX(-50%) translate(-55px, -35px); }
        @media (max-width: 560px) { .pm-card { width: 90vw; height: calc(90vw * 0.486); border-radius: 0; box-shadow: none; } .pm-floating-icon { width: 48px; height: 48px; } .pm-icon-whatsapp { bottom: 7.5vw; left: 18%; transform: translateX(-50%) translate(45px, -33px); } .pm-icon-telegram { bottom: 9vw; left: 50%; transform: translateX(-50%) translate(-2px, -5px); } .pm-icon-viber { bottom: 7.5vw; left: 82%; transform: translateX(-50%) translate(-55px, -35px); } }
