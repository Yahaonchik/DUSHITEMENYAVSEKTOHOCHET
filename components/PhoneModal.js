  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        .pm-floating-icon { position: absolute; width: 30px; height: 30px; opacity: 1; pointer-events: none; }
        .pm-icon-whatsapp { bottom: 42px; left: 18%; transform: translateX(-50%); }
        .pm-icon-telegram { bottom: 50px; left: 50%; transform: translateX(-50%); }
        .pm-icon-viber { bottom: 42px; left: 82%; transform: translateX(-50%); }
        @media (max-width: 560px) { .pm-card { width: 90vw; height: calc(90vw * 0.669); border-radius: 14px; } .pm-floating-icon { width: 24px; height: 24px; } .pm-icon-whatsapp { bottom: 7.5vw; left: 18%; } .pm-icon-telegram { bottom: 9vw; left: 50%; } .pm-icon-viber { bottom: 7.5vw; left: 82%; } }
